 ...
 * @LastEditors: Ptisak
 * @LastEditTime: 2022-07-21 20:50:31
 * @Version: Do not edit
 */
/*********************************************************************************************************************
 * COPYRIGHT NOTICE
...
#define SDA GPIO_READ(3, 6)
#define SDA0() GPIO_SET(3, 6, 0)     // IO口输出低电平
#define SDA1() GPIO_SET(3, 6, 1)     // IO口输出高电平
#define SCL0() GPIO_SET(3, 7, 0)     // IO口输出低电平
#define SCL1() GPIO_SET(3, 7, 1)     // IO口输出高电平
#define DIR_OUT() GPIO_INIT_OU(3, 6) //输出方向
#define DIR_IN()            \
    {                       \
        GPIO_INIT_IN(3, 6); \
    } //输入方向
