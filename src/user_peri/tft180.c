...
#define TFT_SCL(x)  gpio_set_2 (TFT_SCL_port,TFT_SCL_pin	, x)
#define TFT_SDA(x)  gpio_set_2 (TFT_SDA_PORT,TFT_SDA_Pin	, x)
#define REST(x)     gpio_set_2 (REST_PORT,REST_Pin, x)
#define DC(x)       gpio_set_2 (DC_PORT,DC_Pin, x)
#define TFT_CS(x)   gpio_set_2 (TFT_CS_PORT,TFT_CS_Pin, x)
#define BL(x)       gpio_set_2 (BL_PORT,	BL_Pin, x)
#define TFT_DC(x)      DC(x);

void gpio_set_2(uint_fast8_t selectedPort,uint_fast16_t selectedPins,uint8 x)
{
