...
#define IMU963RA_SPI                EUSCI_B2_BASE                                       // 硬件 SPI 号
#define IMU963RA_SPC_PIN            SPI_B2_CLK_P35                            // 硬件 SPI SCK 引脚
#define IMU963RA_SDI_PIN            SPI_B2_MOSI_P36                           // 硬件 SPI MOSI 引脚
#define IMU963RA_SDO_PIN            SPI_B2_MISO_P37                           // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU963RA_CS_PORT            GPIO_PORT_P5                                          // CS 片选引脚
#define IMU963RA_CS_PIN             GPIO_PIN2                                          // CS 片选引脚
#define IMU963RA_CS(x)              (x? (GPIO_setOutputHighOnPin(IMU963RA_CS_PORT, IMU963RA_CS_PIN)): (GPIO_setOutputLowOnPin(IMU963RA_CS_PORT, IMU963RA_CS_PIN)))
...
float   imu963ra_acc_transition     (int16_t acc_value);                          // 将 IMU963RA 加速度计数据转换为实际物理数据
float   imu963ra_gyro_transition    (int16_t gyro_value);                         // 将 IMU963RA 陀螺仪数据转换为实际物理数据
float   imu963ra_mag_transition     (int16_t mag_value);                          // 将 IMU963RA 地磁计数据转换为实际物理数据
