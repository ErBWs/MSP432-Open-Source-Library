...
#define ICM20602_SPI                EUSCI_B2_BASE                                       // 硬件 SPI 号
#define ICM20602_SPC_PIN            SPI_B2_CLK_P35                            // 硬件 SPI SCK 引脚
#define ICM20602_SDI_PIN            SPI_B2_MOSI_P36                           // 硬件 SPI MOSI 引脚
...
float   icm20602_acc_transition     (int16_t acc_value);                          // 将 ICM20602 加速度计数据转换为实际物理数据
float   icm20602_gyro_transition    (int16_t gyro_value);                         // 将 ICM20602 陀螺仪数据转换为实际物理数据
